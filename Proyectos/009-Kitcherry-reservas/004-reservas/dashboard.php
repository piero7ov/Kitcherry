            ...
            <section class="hero-panel">
                <div>
                    ...
                    <?php if ($negocioConfigurado): ?>
                        <p>
                            Sistema preparado para gestionar las reservas de 
            ...
            <section class="content-grid">
                ...
                <article class="panel-card">
                    ...
                    <p>
                        ...
                        configuración del negocio, gestión de mesas y gestión inicial de reservas.
                    </p>

                    <ul class="check-list">
                        <li>Base de datos creada</li>
                        <li>Usuario administrador preparado</li>
                        <li>Configuración del negocio guardada</li>
                        <li>Gestión de mesas disponible</li>
                        <li>Gestión de reservas disponible</li>
                    </ul>
                </article>
                ...
                <article class="panel-card">
                    ...
                    <p>
                        En las siguientes versiones se añadirán listado más avanzado,
                        clientes, fidelización, alertas internas y correos.
                    </p>
