    ...
    <div class="app-layout">
        ...
        <main class="main-content">
            ...
            <section class="hero-panel">
                <div>
                    <h2>Adapta el sistema a tu restaurante</h2>
                    <p>
                        Define los datos principales del negocio, sus reglas de reserva
                        y el horario semanal para organizar mejor el servicio.
                    </p>
                </div>
            </section>
