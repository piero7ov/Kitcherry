                    ...
                    <?php foreach ($servicios as $servicio): ?>
                        <article class="servicio js-reveal">
                            ...
                            <?php if (!empty($servicio["url"]) && !empty($servicio["boton"])): ?>
                                <a href="<?php echo e($servicio["url"]); ?>" class="btn btn-principal" style="margin-top: 18px;" target="_blank" rel="noopener">
    ...
    <section id="producto-destacado" class="seccion fondo-suave">
        <div class="contenedor caso-grid">
            ...
            <div class="caso-principal js-reveal">
                ...
                <p>
                    Nuestro primer producto destacado está pensado para negocios hosteleros que reciben muchas consultas por correo,
                    formulario web u otros canales, y necesitan gestionarlas de forma más rápida, ordenada y profesional.
                </p>

                <p>
                    La solución ayuda a clasificar mensajes, detectar la intención de cada consulta, priorizar solicitudes importantes
                    y preparar borradores de respuesta que pueden ser revisados antes de enviarse.
                </p>

                <ul>
                    <li>Menos tiempo gestionando consultas repetitivas.</li>
                    <li>Mayor control sobre mensajes relacionados con reservas, horarios, carta, ubicación, alérgenos o servicios.</li>
                    <li>Borradores de respuesta editables para mantener siempre el control humano.</li>
                    <li>Mejor trazabilidad de las consultas recibidas y del estado de cada mensaje.</li>
