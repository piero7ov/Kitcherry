...
document.addEventListener("DOMContentLoaded", function () {
    ...
    function crearReconocimientoVoz() {
        ...
        reconocimiento.onend = function () {
            ...
            if (!dictadoActivo) {
                escribirMensajeVoz("Dictado detenido. Puedes procesar el texto con IA local.", "ok");
    ...
    async function procesarConIA() {
        ...
        escribirMensajeVoz("Procesando con IA local...", "activo");
        ...
        try {
            ...
            if (!datos.ok) {
                escribirMensajeVoz(datos.mensaje || "No se pudo procesar el texto.", "error");
                return;
            }

            rellenarItems(datos.items || []);

            if (datos.modo === "fallback") {
                escribirMensajeVoz(datos.mensaje || "Lista generada con separación básica.", "ok");
            } else {
                escribirMensajeVoz("Lista generada con IA local. Revisa antes de guardar.", "ok");
            }

        } catch (error) {
            escribirMensajeVoz("Error al conectar con la IA local.", "error");
        }
    }
