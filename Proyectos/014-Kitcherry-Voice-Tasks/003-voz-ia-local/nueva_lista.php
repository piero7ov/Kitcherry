...
<section class="intro">
    <h2>Nueva lista</h2>
    <p>
        Crea una lista operativa para cocina, sala o avisos generales. Puedes escribirla manualmente
        o dictarla por voz para que la IA local la convierta en elementos separados.
    </p>
</section>
...
<section class="card">
    ...
    <form method="POST" class="formulario formulario-lista">
        ...
        <div class="bloque-voz">
            <div class="bloque-voz-header">
                <div>
                    <h2>Dictado por voz e IA local</h2>
                    <p>
                        Inicia el dictado, di varios elementos seguidos y detén el micrófono cuando termines.
                        Cada frase reconocida se añadirá en una nueva línea.
                    </p>
                </div>

                <div class="acciones-voz">
                    <button type="button" class="btn btn-secundario" data-btn-iniciar-dictado>
                        Iniciar dictado
                    </button>

                    <button type="button" class="btn btn-secundario" data-btn-detener-dictado disabled>
                        Detener dictado
                    </button>

                    <button type="button" class="btn" data-btn-procesar-ia>
                        Procesar con IA
                    </button>
                </div>
            </div>
            ...
            <div class="campo">
                <label for="texto_original">Texto dictado o notas generales</label>
                <textarea 
                    id="texto_original" 
                    name="texto_original" 
                    rows="6"
            ...
            <p class="mensaje-voz" data-mensaje-voz>
                Pulsa “Iniciar dictado” para usar el micrófono o escribe el texto manualmente.
            </p>
        </div>
