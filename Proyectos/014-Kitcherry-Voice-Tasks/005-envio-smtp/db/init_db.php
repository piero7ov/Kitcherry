...
try {
    ...
    $mensaje = "Base de datos preparada correctamente.";
    $detalle = "Las tablas, grupos y datos iniciales están listos para trabajar.";

} catch (PDOException $e) {
    $mensaje = "Error al preparar la base de datos.";
...
<section class="intro">
    ...
    <p>
        Este proceso revisa la estructura SQLite, prepara las tablas necesarias
        y deja disponibles los grupos y trabajadores iniciales para crear listas operativas.
    </p>
</section>
