...
<section class="intro">
    ...
    <p>
        Herramienta interna para crear listas de cocina, sala o avisos generales.
        Puedes gestionar el personal, crear listas por escrito o por voz, revisar el resultado
        y preparar la lista para enviarla al equipo.
    </p>
</section>
...
<section class="acciones-grid">
    ...
    <a href="nueva_lista.php" class="accion-card">
        <h2>Crear lista</h2>
        <p>Crear una lista para cocina, sala o avisos generales usando escritura o dictado por voz.</p>
    </a>
