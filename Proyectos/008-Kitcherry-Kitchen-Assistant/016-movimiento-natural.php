...
// Archivo: 010-avatar-estatico.php
...
<body>
    ...
    <script>
        ...
        function animarAvatar3D() {
            ...
            /*
            intensidadHabla suaviza el cambio entre:
            - movimiento normal
            - movimiento cuando habla
            */
            if (avatarHablando) {
            ...
            if (avatarRig) {
                // Movimiento base muy leve, siempre activo
                ...
                // Movimiento extra cuando habla: más vertical y menos lateral
