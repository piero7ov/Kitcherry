...
<body>
    ...
    <script>
        ...
        function animarAvatar3D() {
            ...
            if (mouthLine) {
                if (avatarHablando) {
                    const escalaX = 1 + Math.abs(Math.sin(t * 10)) * 0.25;
                    const escalaY = 1 + Math.abs(Math.sin(t * 18)) * 2.2;

                    mouthLine.setAttribute("scale", `${escalaX} ${escalaY} 1`);
                    mouthLine.setAttribute("color", "#C2182B");
                } else {
                    mouthLine.setAttribute("scale", "1 1 1");
                    mouthLine.setAttribute("color", "#111111");
                }
            }
