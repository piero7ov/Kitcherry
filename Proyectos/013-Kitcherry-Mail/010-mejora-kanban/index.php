...
// ==========================================================
// PROCESO DE LOGIN / CONFIGURACIÓN DE CUENTA
// ==========================================================
...
if (function_exists('obtenerPlantillasParaVista')) {
    $plantillasIniciales = obtenerPlantillasParaVista($pdo);
} else {
    $plantillasIniciales = [
        'recibido' => '<p>Hola,</p><p>Gracias por contactar con nosotros. Hemos recibido tu mensaje correctamente y lo revisaremos lo antes posible.</p><p>Un saludo,<br>Equipo Kitcherry</p>',
        'info' => '<p>Hola,</p><p>Para poder ayudarte mejor, ¿podrías enviarnos un poco más de información sobre tu consulta?</p><p>Un saludo,<br>Equipo Kitcherry</p>',
        'gracias' => '<p>Hola,</p><p>Muchas gracias por tu mensaje. Quedamos atentos a cualquier otra consulta.</p><p>Un saludo,<br>Equipo Kitcherry</p>'
    ];
}
                ...
                <div class="login-grid">
                    <label>
                        ...
                        <input
                            ...
                            placeholder="pieroolivaresdev@gmail.com"
                            required
                        >
                    </label>
...
<?php else: ?>
    ...
    <div class="app-shell">
        ...
        <header class="topbar">
            ...
            <div class="topbar-actions">
                <span class="sync-pill" id="syncStatus">
                    <?= e((string) $cuentaActiva['email']) ?>
                </span>

                <button class="btn btn-light" id="btnSync" type="button">
                    Sincronizar
                </button>

                <a href="mantenimiento.php" class="btn btn-light">
                    Mantenimiento
                </a>

                <a class="btn btn-danger btn-logout" href="logout.php">
                    Salir
                </a>
            </div>
        </header>
        ...
        <main class="mail-layout">
            ...
            <aside class="sidebar">
                ...
                <section class="sidebar-card">
                    ...
                    <button class="status-filter active" data-status="all" type="button">
                        Todos
                    </button>

                    <button class="status-filter" data-status="pendiente" type="button">
                        Pendientes
                    </button>

                    <button class="status-filter" data-status="revision" type="button">
                        En revisión
                    </button>

                    <button class="status-filter" data-status="respondido" type="button">
                        Respondidos
                    </button>

                    <button class="status-filter" data-status="importante" type="button">
                        Importantes
                    </button>
                </section>
                ...
                <section class="sidebar-card">
                    ...
                    <div class="view-switch">
                        <button class="view-btn active" id="btnListView" type="button">
                            Lista
                        </button>

                        <button class="view-btn" id="btnKanbanView" type="button">
                            Kanban
                        </button>
                    </div>
                </section>
                ...
                <section class="sidebar-card muted-card">
                    <h2>Cuenta</h2>
                    <p><?= e((string) $cuentaActiva['email']) ?></p>
                    <p>IMAP: <?= e((string) $cuentaActiva['imap_host']) ?>:<?= e((string) $cuentaActiva['imap_port']) ?></p>
                    <p>SMTP: <?= e((string) $cuentaActiva['smtp_host']) ?>:<?= e((string) $cuentaActiva['smtp_port']) ?></p>
                </section>

                <section class="sidebar-card muted-card">
                    <h2>Nota</h2>
                    <p>Los contadores muestran mensajes individuales. Gmail puede agrupar varios mensajes dentro de una conversación.</p>
                </section>
            </aside>
            ...
            <section class="mail-list-panel">
                ...
                <div class="kanban-board hidden" id="kanbanBoard" aria-label="Vista Kanban de correos">
                    ...
                    <article class="kanban-column" data-kanban-status="importante">
                        <h3>Importantes</h3>
                        <div class="kanban-dropzone" id="kanbanImportante"></div>
                    </article>
            ...
            <section class="mail-detail-panel" id="mailDetail">
                ...
                <article class="mail-detail hidden" id="detailContent">
                    <div class="detail-top-actions">
                        <button class="btn btn-light" id="btnMarkRead" type="button">
                            Marcar leído/no leído
                        </button>

                        <button class="btn btn-light" id="btnArchive" type="button">
                            Archivar
                        </button>

                        <button class="btn btn-light hidden" id="btnRestoreInbox" type="button">
                            Restaurar
                        </button>

                        <button class="btn btn-danger" id="btnTrash" type="button">
                            Papelera
                        </button>
                    </div>
                    ...
                    <section class="attachments-panel hidden" id="attachmentsPanel">
                        ...
                        <p class="attachments-note">Los adjuntos se detectan desde el correo sincronizado.</p>
                    </section>
                    ...
                    <div class="detail-actions">
                        ...
                        <button class="btn btn-light" id="btnForward" type="button">
                            Reenviar
                        </button>
                    ...
                    <section class="notes-panel">
                        ...
                        <div class="note-form">
                            <input
                                type="text"
                                id="noteInput"
                                placeholder="Añadir nota privada para este correo..."
                            >

                            <button class="btn btn-light" id="btnAddNote" type="button">
                                Añadir
                            </button>
                        </div>
    ...
    <!-- ==========================================================
    MODAL DE REDACCIÓN / RESPUESTA / REENVÍO / BORRADOR
    =========================================================== -->
    <section class="compose-modal hidden" id="composeModal" aria-label="Panel de redacción">
        <div class="compose-card">
            <header class="compose-header">
                ...
                <button class="icon-btn" id="btnCloseCompose" type="button" aria-label="Cerrar redacción">
                    ×
                </button>
            </header>
            ...
            <form id="composeForm" class="compose-form">
                ...
                <footer class="compose-footer">
                    <button class="btn btn-light" id="btnSaveDraft" type="button">
                        Guardar borrador
                    </button>
