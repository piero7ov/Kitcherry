    ...
    <main class="login-page">
        <section class="login-card">
            ...
            <form method="post" class="login-form">
                ...
                <p class="login-note">
                    Para SMTP por sockets, el cifrado indica cómo se abre la conexión: puerto 587 usa STARTTLS y puerto 465 usa SSL directo.
                    La contraseña solo se mantiene durante la sesión activa.
                </p>
