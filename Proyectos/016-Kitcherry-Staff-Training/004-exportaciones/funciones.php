...
function crearOActualizarUsuarioAdmin(PDO $conexion, string $usuario, string $password, string $rol = 'admin'): void
{
    ...
    if ($usuario === '' || $password === '' || $rol === '') {
        throw new InvalidArgumentException('Usuario, contraseña y rol son obligatorios.');
    }
