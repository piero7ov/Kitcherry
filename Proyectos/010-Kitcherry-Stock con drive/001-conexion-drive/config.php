...
// Esta hoja funciona como nuestra "base de datos" principal.
...
// Texto breve para mostrar en la cabecera.
$DESCRIPCION_PROYECTO = "Sistema de consulta de stock conectado a Google Drive como base de datos.";