...
/**
 * Envía la solicitud a Google Apps Script.
 */
function enviarSolicitudAAppsScript($url, $json)
{
    ...
    curl_setopt_array($curl, [
        ...
        // IMPORTANTE:
        // Forzamos HTTP/1.1 para evitar errores HTTP/2 con Apps Script.
        CURLOPT_HTTP_VERSION => CURL_HTTP_VERSION_1_1,

        // En desarrollo local con XAMPP evitamos problemas de certificado.
        ...
        // User-Agent para evitar respuestas raras de algunos servidores.
