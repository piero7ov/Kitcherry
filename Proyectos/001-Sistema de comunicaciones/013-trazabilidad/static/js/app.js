...
function recomputeDashboardFromDataset() {
    if (!ultimoDataset) return;

    const allEmails = [
        ...(ultimoDataset.automaticos || []),
        ...(ultimoDataset.importantes || []),
        ...(ultimoDataset.papelera || [])
    ];
...
function refreshLocalView() {
    ...
    updateDashboard(ultimoDataset.dashboard || {});
}
