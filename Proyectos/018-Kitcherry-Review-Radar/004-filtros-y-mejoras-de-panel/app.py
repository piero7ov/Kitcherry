...
# 004 - Alta manual + SQLite + importación CSV/JSON + filtros básicos
# ==========================================================
...
def construir_where_filtros(filtros):
    ...
    if estado == "pendiente":
        ...
        condiciones.append("a.review_id IS NOT NULL")
...
def calcular_estadisticas(filtros=None):
    ...
    En la 004 se calculan sobre el resultado filtrado.
    """
