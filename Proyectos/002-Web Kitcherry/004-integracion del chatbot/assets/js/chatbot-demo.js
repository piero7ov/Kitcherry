...
// Archivo: chatbot-demo.js
// Guardar este archivo en UTF-8
// ==========================================================

console.log("chatbot-demo.js cargado: versión web-integracion-2");
...
const modeConfig = {
    kitcherry: {
        ...
        disclaimer: "El chatbot puede cometer errores. La información mostrada es orientativa y forma parte de una prueba interactiva del sistema Kitcherry.",
        suggestions: [
            {
    ...
    restaurante: {
        ...
        hint: "Estás usando el modo restaurante. Este modo muestra cómo el chatbot puede adaptarse a un negocio hostelero concreto usando información de Kamado.",
        welcome: "Hola, estás usando el modo restaurante. Puedes consultar información sobre Kamado, su carta, alérgenos, reservas, delivery, cócteles o platos de referencia.",
