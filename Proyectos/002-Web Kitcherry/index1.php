...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    if ($nombre === "" || $email === "" || $mensaje === "") {
        ...
        $mensajeFormulario = "Gracias, " . $nombre . ". Hemos recibido tu consulta. En una versión real, este formulario podría enviarse por correo o guardarse en base de datos.";
        $tipoMensaje = "ok";
    }
}
...
$videoPath = "video/demo-consultas.mp4";
                        ...
                        <?php else: ?>
                            <div class="video-placeholder">
                                <div class="video-placeholder-contenido">
                                    ...
                                    <h3>Espacio reservado para vídeo demostrativo</h3>
                                    <p>
                                        Aquí se incorporará más adelante un vídeo mostrando el funcionamiento del producto,
                                        sus pantallas principales y el beneficio real para un negocio hostelero.
                                    </p>
                                </div>
                            </div>
                        <?php endif; ?>
