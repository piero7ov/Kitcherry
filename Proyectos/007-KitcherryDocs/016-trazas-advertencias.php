...
// ==========================================================
// Objetivo:
// - Mantener vista cliente / vista interna
...
// - Añadir trazas, advertencias alimentarias y platos sensibles
// - Mostrar advertencias resumidas en carta y detalle completo en su sección
// ==========================================================
            ...
            <?php else: ?>
                <div class="sensitive-grid">
                    <?php foreach ($platosSensibles as $itemSensible): ?>
                        ...
                        if (!$hayClienteSensible) {
                            $claseTarjetaSensible = "internal-only";
                        } else {
                            $claseTarjetaSensible = "";
                        }
