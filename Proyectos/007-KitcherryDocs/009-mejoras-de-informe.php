...
// =========================================================
// Objetivo:
// - Mejorar el visor visual para usuarios de hostelería
// - Usar identidad corporativa de Kitcherry
// - Separar estilos en styles.css
// - Priorizar consulta rápida de carta, platos y alérgenos
// ==========================================================
...
<div class="page">
    ...
    <main class="container">
        ...
        <section class="hero">
            <div class="hero-main">
                <span class="eyebrow">Módulo 04 · Carta, platos y alérgenos</span>
                ...
                <div class="hero-actions">
                    <a href="#consulta" class="btn btn-white">Buscar un plato</a>
                    <a href="#documentos" class="btn btn-soft">Ver documentos procesados</a>
                </div>
            </div>
