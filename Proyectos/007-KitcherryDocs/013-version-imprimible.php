<?php
// ==========================================================
// KITCHERRY DOCS - ITERACIÓN 13
// Archivo: 013-version-imprimible.php
// Objetivo:
// - Mantener consulta por alérgenos
// - Mantener matriz de alérgenos
// - Mantener estados de revisión editables
// - Añadir impresión/exportación desde navegador
// - Preparar carta, tabla e informe interno para imprimir o guardar como PDF
// - Añadir versión compacta de tabla de alérgenos para evitar cortes en impresión
// ==========================================================
...
<div class="page">
    ...
    <main class="container">
        ...
        <div class="print-header">
            ...
            <p>Documento generado para consulta interna de carta, platos, ingredientes y alérgenos.</p>
        </div>
                ...
                <tbody>
                    <?php foreach ($platos as $plato): ?>
                        ...
                        <tr>
                            ...
                            <td><?= e(textoEstadoRevision($estado)) ?></td>
                        </tr>
                    <?php endforeach; ?>
                </tbody>
            </table>
        ...
        <section id="impresion" class="section no-print">
            ...
            <div class="print-actions-grid">
                ...
                <article class="card print-card">
                    ...
                    <p>
                        Genera una vista compacta de alérgenos por plato, útil para revisión interna o consulta rápida.
                    </p>
        ...
        <section id="documentos" class="section print-section print-interno">
            <div class="section-title">
                <div>
                    ...
                    <?php foreach ($resultadosAnalisis as $resultado): ?>
                        ...
                        <article class="card doc-card">
                            ...
                            <?php if (is_array($advertenciasIa) && count($advertenciasIa) > 0): ?>
                                <details class="doc-warning" open>
        ...
        <?php if (!empty($resumenes)): ?>
            <section class="section print-section print-interno print-interno-extra">
                <div class="section-title">
                    <div>
