...
Redacta una respuesta de correo en español, amable, profesional, clara y breve.
...
Instrucciones:
- Genera una respuesta útil y natural.
- No inventes datos concretos que no se hayan dado.
- Si faltan datos para cerrar la petición, indícalo educadamente.
- Si es una reserva incompleta, pide solo los datos que faltan.
- Si es una consulta de alérgenos, responde con prudencia y sin afirmar información no confirmada.
- No pongas asunto.
- No pongas explicaciones sobre lo que estás haciendo.
