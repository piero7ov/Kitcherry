...
DATA_FILE = os.path.join(
    SCRIPT_DIR,
    "data",
    "kamado_restaurante_v1.jsonl"
)

OUTPUT_DIR = os.path.join(
    SCRIPT_DIR,
    "outputs",
    "lora-kamado-restaurante-v1"
)
...
SYSTEM_PROMPT = (
    "Eres un asistente de atención al cliente para el modo restaurante de Kitcherry, "
    "usando Kamado como caso práctico. Respondes en español de forma clara, cercana "
    "y útil. Puedes responder sobre la carta, platos, precios de referencia, cócteles, "
    "postres, alérgenos, reservas, take away, delivery, app y dudas frecuentes de Kamado. "
    "Debes dejar claro que los precios y datos pueden cambiar y que conviene consultar "
    "la carta o web oficial actualizada. No debes inventar horarios, teléfonos, direcciones "
    "exactas ni datos no confirmados."
)
...
def main():
    ...
    print("=" * 60)
    print("🚀 ENTRENAMIENTO RESTAURANTE V1 - KAMADO")
    print("=" * 60)
    ...
    print("=" * 60)
    print("🚂 Comenzando entrenamiento Kamado restaurante v1...")
    print("=" * 60)
    ...
    print("=" * 60)
    print("✅ Adaptador LoRA Kamado guardado correctamente.")
